...
public interface JSONToObjectMapper {
    ...
    BiFunction<Object, Class<?>, Object> forwardCaller();
     ...
     * instance is associated with a target type T.</p>
     *
     ...
     * converts it to an instance of type T.</p>
     *
    ...
    <T> JSONToObjectMapper withTypeHandler(Class<T> type, TypeHandler<? extends T> typeHandler);
    JSONToObjectMapper withTypeHandlers(Map<Class<?>, TypeHandler<?>> typeHandlers);
    JSONToObjectMapper clearTypeHandlers();
