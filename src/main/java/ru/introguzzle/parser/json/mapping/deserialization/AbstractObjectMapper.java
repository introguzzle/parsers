...
import ru.introguzzle.parser.json.mapping.ClassHierarchyTraverseUtilities;
import ru.introguzzle.parser.json.mapping.FieldAccessorImpl;
...
public abstract class AbstractObjectMapper implements ObjectMapper {
    ...
    public <T> T map(JSONObject object, Class<T> type) {
        ...
        List<Field> fields = getFieldAccessor().get(type);
        for (Field field : fields) {
            field.setAccessible(true);

            String name = getNameConverter().convert(field);
