...
import ru.introguzzle.parser.json.mapping.deserialization.InvokeObjectMapper;
import ru.introguzzle.parser.json.mapping.deserialization.ObjectMapper;
import ru.introguzzle.parser.json.mapping.reference.StandardCircularReferenceStrategies;
import ru.introguzzle.parser.json.mapping.serialization.JSONMapper;
import ru.introguzzle.parser.json.mapping.serialization.JSONMapperImpl;
import ru.introguzzle.parser.json.mapping.type.JSONType;
import ru.introguzzle.parser.xml.entity.XMLDocument;
import ru.introguzzle.parser.foreign.Other;
...
public class ObjectMapperTest {
    ...
    @Getter
    @ToString
    @JSONEntity(constructorArguments = {"age", "name"})
    @SuppressWarnings("ALL")
    ...
    @Getter
    @ToString
    @JSONEntity(constructorArguments = {"age", "name", "next"})
    @SuppressWarnings("ALL")
    ...
    @Getter
    @ToString
    @JSONEntity(constructorArguments = {"firstName", "lastName"})
    @SuppressWarnings("ALL")
    ...
    @Getter
    @ToString
    @JSONEntity(constructorArguments = {"firstName", "lastName", "address", "numbers"})
    @SuppressWarnings("ALL")
    @EqualsAndHashCode
