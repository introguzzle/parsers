...
public class ObjectTOJsonMapperTest {
    ...
    public void test_inheriting_with_annotations() {
        ...
        JSONObject resultObject = objectToJSONMapper
    ...
    public void test_node() {
        ...
        JSONObject rootObject = objectToJSONMapper.toJSONObject(root, MappingContext.getDefault());
    ...
    public void test_json_entity_annotation_all_excluded() {
        @JSONEntity(excluded = {"valueValue1", "valueValue2", "valueValue3"})
        @Getter
        class None {
            int valueValue1;
            int valueValue2;
        ...
        JSONObject object = objectToJSONMapper.toJSONObject(none, MappingContext.getDefault());
    ...
    public void test_json_entity_annotation_some_excluded() {
        @JSONEntity(excluded = {"valueValue1"})
        @Getter
        class None {
    ...
    public void test_enums_collections_and_arrays() {
        ...
        JSONObject object = objectToJSONMapper.toJSONObject(data, MappingContext.getDefault());
    ...
    public void test_type_handlers() {
        var objectToJSONMapper = new ObjectToJSONMapperImpl()
    ...
    public void test_interface() {
        JSONObject object = objectToJSONMapper.toJSONObject(new Implements(), MappingContext.getDefault());
        assertNull(object);
    }
}