...
import ru.introguzzle.parser.foreign.Foreign;
...
public class JSONMapperTest {
    ...
    public void test_injections() {
        ...
        mapper2.bindTo(Set.of(Foreign.class, ru.introguzzle.parser.foreign.Test.class));

        var test = new ru.introguzzle.parser.foreign.Test("doesnt matter");
